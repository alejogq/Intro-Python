...
class Product:
    ...
    def __init__(self, window):
        # Initializations 
        self.wind = window
        self.wind.title('Precios de productos')
        ...
        ttk.Button(frame,
                   ...
                   command = self.add_product).grid(row = 3,
                                                    columnspan = 2,
                                                    sticky = W + E)
        ...
        # Buttons
        ttk.Button(text = 'Borrar',
                   command = self.delete_product).grid(row = 5,
                                                       column = 0,
                                                       sticky = W + E)
                                                       
        ttk.Button(text = 'Editar',
                   command = self.edit_product).grid(row = 5,
                                                     column = 1,
                                                     sticky = W + E)
    ...
    def add_product(self):
        if self.validation():
            ...
            self.message['text'] = 'Item {} añadido Satisfactoriamnte'.format(self.name.get())
            self.name.delete(0, END)
            self.price.delete(0, END)
        else:
            self.message['text'] = 'Debe Ingresar Nombre y Precio'
        self.get_products()
    ...
    def delete_product(self):
        ...
        try:
           self.tree.item(self.tree.selection())['text'][0]
            ...
            self.message['text'] = 'Seleccione un item para borrar'
            return
        self.message['text'] = ''
    ...
    def edit_product(self):
        ...
        try:
            ...
            self.message['text'] = 'Por favor, Seleccione un ítem'
            return
    ...
    def edit_records(self, new_name, name, new_price, old_price):
        ...
        self.message['text'] = 'Item  {} actualizado satisfactoriamente'.format(name)
        self.get_products()
