...
#%%
print()
print("Imprimir la suma de la diagonal principal, traza: \n",matriz.trace())

#%%
print()
t=matriz.T
print("Imprimir la suma de la diagonal secundaria: \n",t.trace())

#%%
print()
matriz_aleatoria = numpy.random.randint(1,10,(3,3))
print("Matriz aleatoria de enteros: \n",matriz_aleatoria)
